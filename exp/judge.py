...
def save_results_to_file(results, output_file="exp/Self-Reminder/Judge_Self_Reminder.json"):
    with open(output_file, "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=4)
    print(f"Data has been saved to {output_file}")

# Main program entry point
dataset = load_dataset('exp/Self-Reminder/result_selfReminder.json')  # Replace with the actual file path
