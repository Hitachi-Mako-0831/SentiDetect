...
def save_results_to_file(results, output_file="exp/Goal-Prioritization/Judge_GP.json"):
    with open(output_file, "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=4)
    print(f"Data has been saved to {output_file}")

# Main program entry point
dataset = load_dataset('exp/Goal-Prioritization/result_GP.json')  # Replace with the actual file path
